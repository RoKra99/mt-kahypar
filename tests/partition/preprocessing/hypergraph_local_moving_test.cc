...
//     Volume before = mt_kahypar::metrics::hyp_modularity(*chg, communities, hlmm);
//     PartitionID destination_community = hlmm.calculateBestMove(*chg, communities, 0, hlmm._large_edge_contribution_map.local());
//     hlmm.makeMove(*chg, communities, 0, destination_community);
//     Volume after = mt_kahypar::metrics::hyp_modularity(*chg, communities, hlmm);
...
//     context.shared_memory.num_threads = 1;
//     context.preprocessing.community_detection.hyperedge_size_caching_threshold = 0;
//     ds::CommunityHypergraph *chg(hypergraph, context);
//     HypergraphLocalMovingModularity hlmm(*chg, context);
//     parallel::scalable_vector<HypernodeID> communities = { 0,1,2,3,4,5,6 };
//     hlmm.initializeCommunityVolumes(*chg, communities);
//     Volume before = mt_kahypar::metrics::hyp_modularity(*chg, communities, hlmm);
//     CommunityMove move = hlmm.calculateBestMove(*chg, communities, 1);
//     hlmm.makeMove(*chg, communities, move);
//     Volume after = mt_kahypar::metrics::hyp_modularity(*chg, communities, hlmm);
//     ASSERT_TRUE(mt_kahypar::math::are_almost_equal_ld(move.delta, after - before, PRECISION));
//     ASSERT_DOUBLE_EQ(move.delta, after - before);
// }
...
//     hlmm.initializeCommunityVolumes(*chg, communities);
//     Volume before = mt_kahypar::metrics::hyp_modularity(*chg, communities, hlmm);
//     CommunityMove move = hlmm.calculateBestMove(*chg, communities, 2);
//     hlmm.makeMove(*chg, communities, move);
//     Volume after = mt_kahypar::metrics::hyp_modularity(*chg, communities, hlmm);
//     ASSERT_TRUE(mt_kahypar::math::are_almost_equal_ld(move.delta, after - before, PRECISION));
//     ASSERT_DOUBLE_EQ(move.delta, after - before);
...
//     hlmm.initializeCommunityVolumes(*chg, communities);
//     Volume before = mt_kahypar::metrics::hyp_modularity(*chg, communities, hlmm);
//     CommunityMove move = hlmm.calculateBestMove(*chg, communities, 3);
//     hlmm.makeMove(*chg, communities, move);
//     Volume after = mt_kahypar::metrics::hyp_modularity(*chg, communities, hlmm);
//     ASSERT_TRUE(mt_kahypar::math::are_almost_equal_ld(move.delta, after - before, PRECISION));
//     ASSERT_DOUBLE_EQ(move.delta, after - before);
...
//     hlmm.initializeCommunityVolumes(*chg, communities);
//     Volume before = mt_kahypar::metrics::hyp_modularity(*chg, communities, hlmm);
//     CommunityMove move = hlmm.calculateBestMove(*chg, communities, 4);
//     hlmm.makeMove(*chg, communities, move);
//     Volume after = mt_kahypar::metrics::hyp_modularity(*chg, communities, hlmm);
//     ASSERT_TRUE(mt_kahypar::math::are_almost_equal_ld(move.delta, after - before, PRECISION));
//     ASSERT_DOUBLE_EQ(move.delta, after - before);
...
//     hlmm.initializeCommunityVolumes(*chg, communities);
//     Volume before = mt_kahypar::metrics::hyp_modularity(*chg, communities, hlmm);
//     CommunityMove move = hlmm.calculateBestMove(*chg, communities, 5);
//     hlmm.makeMove(*chg, communities, move);
//     Volume after = mt_kahypar::metrics::hyp_modularity(*chg, communities, hlmm);
//     ASSERT_TRUE(mt_kahypar::math::are_almost_equal_ld(move.delta, after - before, PRECISION));
//     ASSERT_DOUBLE_EQ(move.delta, after - before);
...
//     hlmm.initializeCommunityVolumes(*chg, communities);
//     Volume before = mt_kahypar::metrics::hyp_modularity(*chg, communities, hlmm);
//     CommunityMove move = hlmm.calculateBestMove(*chg, communities, 6);
//     hlmm.makeMove(*chg, communities, move);
//     Volume after = mt_kahypar::metrics::hyp_modularity(*chg, communities, hlmm);
//     ASSERT_TRUE(mt_kahypar::math::are_almost_equal_ld(move.delta, after - before, PRECISION));
//     ASSERT_DOUBLE_EQ(move.delta, after - before);
